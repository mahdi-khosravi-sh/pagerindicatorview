package com.mahdikh.pagerindicatorview

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import androidx.viewpager2.widget.ViewPager2
import com.mahdikh.vision.pagerindicatorview.widget.PagerIndicatorView
import com.mahdikh.vision.pagerindicatorview.progress.InstanceProgress
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pagerIndicator = findViewById<PagerIndicatorView>(R.id.pagerIndicator)
